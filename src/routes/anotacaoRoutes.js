...
router.post('/cadastrar_anotacao', autenticacaoController.verificarAutenticacao, anotacaoController.cadastrarAnotacao) // tipo post, se passar pela autentificador, cadastra sua analise.
